...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # TODO: 6a. Print the number of NOT-dog images from results_stats_dic
    print("{:20}: {:3d}".format('N Not-Dog Images', results_stats_dic['n_notdogs_img']))

    # Prints summary statistics (percentages) on Model Run
    print(" ")
    for key in results_stats_dic:
        # TODO: 6b. Print all the percentages in results_stats_dic
        if key.startswith('p'):
    ...
    if print_incorrect_dogs and (
        ...
        for key in results_dic:
            # TODO: 6c. Print the pet label and classifier label when the classifier function misclassified dogs
            if (
                (results_dic[key][3] == 1 and results_dic[key][4] == 0) or
                (results_dic[key][3] == 0 and results_dic[key][4] == 1)
            ):
                print(
                    "Pet Label: {:>26}   Classifier Label: {:>30}".format(
